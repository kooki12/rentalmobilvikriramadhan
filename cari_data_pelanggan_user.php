...
<td><?=$data['nama_vikri']?></td>
<td><?=$data['no_hp_vikri']?></td>
<td><?=$data['alamat_vikri']?></td>

<td>
<a href="edit_data_pelanggan_user.php?nik_ktp_vikri=<?=$data['nik_ktp_vikri']?>" class='btn
btn-primary'>Edit</a>
<a href="delete_data_pelanggan_user.php?nik_ktp_vikri=<?=$data['nik_ktp_vikri']?>"
